...
<section class="container container_section">
	<div class="contentWrap">
		<div class="content">
			<div class="article_position"><i>您的位置：</i><a href="<?php echo BLOG_URL; ?>" title="<?php echo $blogname; ?>"><?php echo $blogname; ?></a> <small>&gt;</small><?php blog_sort($logid); ?><small>&gt;</small> <?php echo $log_title; ?></div>
			<header class="article_header">
				...
				<div class="article_meta">
					...
					<span><i class="fa fa fa-folder-open"></i> <?php blog_sort($logid); ?></span>
					<?php echo editflg($logid,$author); ?>
				</div>
			</header>
			...
			<nav class="article_nav"><?php neighbor_log($neighborLog); ?></nav>
